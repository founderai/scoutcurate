    ...
    <article className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3 mt-4 mb-4">
          <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-yellow-100 text-yellow-700">Curate · Adults</span>
          <span className="text-xs text-gray-400">March 2026 · 6 min read</span>
        </div>
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-[15px] leading-relaxed text-gray-700">
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">The Strategy: Upgrade Something They Already Love</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">High-End Coffee & Tea</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">Unique Home Gadgets They Don't Know They Want</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">Luxury Experiences Wrapped in a Gift</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">The Curate Mode Advantage</h2>
        <p>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 text-center not-prose">
          <p className="font-bold text-white mb-1">Let AI find the perfect gift</p>
          <p className="text-sm text-gray-400 mb-4">Describe the person's vibe, lifestyle, and taste — Curate gives you 25 luxury picks in seconds.</p>
          <a
